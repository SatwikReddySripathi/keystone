...
class BaseConnector(ABC):
    ...
    def extra_flags(self, records: list[dict], changes: dict) -> dict:
        """
        Optional connector-specific flags merged into the preview flags dict.
        Override in connectors that need policy rules beyond the standard set.
        Policy YAML can reference these with  flag: your_flag_name.
        """
        return {}