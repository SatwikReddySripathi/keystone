...
-- 12. APPROVERS: who is authorized to approve actions.
...
def init_db():
    ...
    # Seed approvers
    approvers = [
        ("EMP001", "Sarah Chen", "sarah.chen@company.com", "Senior Operations Lead", "Platform Engineering", "*"),
        ("EMP002", "James Rodriguez", "james.r@company.com", "VP of Engineering", "Engineering", "*"),
        ("EMP003", "Priya Patel", "priya.p@company.com", "IT Service Manager", "IT Operations", "servicenow"),
        ("EMP004", "Michael Kim", "michael.k@company.com", "Security Analyst", "Security", "servicenow,jira"),
        ("EMP005", "Lisa Wang", "lisa.w@company.com", "Change Manager", "Change Management", "*"),
    ]
    for emp_id, name, email, designation, department, tools in approvers:
        conn.execute(
            """INSERT OR IGNORE INTO approvers
               (employee_id, name, email, designation, department, authorized_tools)
               VALUES (?,?,?,?,?,?)""",
            (emp_id, name, email, designation, department, tools)
        )
