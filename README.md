...
- `sdk/launch_demo.py` seeds the strongest short-form statuses for a launch video
- `sdk/investor_workflow_demo.py` guides an end-to-end approval workflow for investor demos
- `DEMO_VIDEO_RUNBOOK.md` includes the shot list, narration, and recording setup
